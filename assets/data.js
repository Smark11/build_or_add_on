...
const DATA = {
  ...
  addition: {
    intro: "The family already has 4 bedrooms — the real gap is living space, not sleeping space. Three facts shape every option: the area over the garage is already finished living space (the kitchen), so building up there isn't available; the 40-ft R-40 side-yard setback sends new space straight off the rear (or down into the basement); and the Weatogue comp ceiling (~$650–700K) caps the defensible all-in spend at roughly $100–150K. Because the main floor sits above the garage, a rear addition is built up to that level on a full foundation. All figures are 2026 Hartford-County pricing.",
    ...
    scenarios: [
      ...
      { key: "B", name: "Rear great room + mudroom", tag: "Ground-floor rear", get: "Vaulted family/great room + mudroom off the back, level with the kitchen. No bedroom.", lo: 110000, hi: 175000, sqft: "+430–600 above grade", recoup: "22–40%", time: "4–6 mo", note: "Built up to the raised main floor on a full foundation; centered to clear the 40-ft side yard.", rec: false },

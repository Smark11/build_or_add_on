...
const DATA = {
  ...
  addition: {
    ...
    scenarios: [
      ...
      { key: "H", plan: "Plan H", name: "Reconfigure + expand the kitchen", tag: "Reconfig + open kitchen", get: "Everything in Plan G, plus the kitchen opens into the adjacent unused formal living room and is remodeled into a large open kitchen with an island — dead space becomes the home's best feature.", lo: 175000, hi: 320000, sqft: "~1,050 sq ft gained/reclaimed", recoup: "~60–72% blended", time: "7–11 mo", note: "The strongest big plan on blended return (the kitchen pays back best), but firmly a forever-home spend past the ceiling. Keep the kitchen midrange ($55–90K) for the best return; upscale pushes past $300K and recoups least.", rec: false },
    ],
    lineItems: [
  ...
  floorplans: {
    ...
    options: [
      ...
      { key: "B", plan: "Plan B", title: "Add a rear great room (optional, off the deck side)", note: "If they want more than they have, a single-story great room + mudroom can be added off the rear at the main-floor level (where the deck is). They already have a family room, so this is extra space — and the great room is the bulk of the cost.",
        plans: [
      ...
      { key: "G", plan: "Plan G", title: "Convert garage + finish walkout + new 2-car garage", note: "The tuck-under garage (~528 sf) becomes a lower-level family room under the kitchen, the ~384 sq ft walkout is finished, and a new 2-car garage restores parking. (Main and upper levels unchanged.)",
        plans: [
      ...
      { key: "H", plan: "Plan H", title: "Reconfigure + expand the kitchen", note: "Everything in Plan G, plus the eat-in kitchen opens into the adjacent unused formal living room to become one large kitchen + family/keeping room with an island. (Lower level as in Plan G.)",
        plans: [
